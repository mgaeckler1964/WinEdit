...
"<string name=\"CONFIG_FILES\" caption=\"Configuration Files(*.ini;*.cfg;*.inf)|*.ini;*.cfg;*.inf|\" id=\"195\" />\n"
"<string name=\"GITHUB_FILES\" caption=\"Github Textfiles(*.md)|*.md|\" id=\"196\" />\n"
"<string name=\"HEADER_FILES\" caption=\"Header Files(*.hpp;*.h;*.rh)|*.hpp;*.h;*.rh|\" id=\"197\" />\n"
"<string name=\"HELP_PROJECTS\" caption=\"Help Projects(*.hpj)|*.hpj|\" id=\"198\" />\n"
"<string name=\"HTML_FILES\" caption=\"HTML Files(*.html;*.htm)|*.html;*.htm|\" id=\"199\" />\n"
"<string name=\"JAVA_SCRIPTS\" caption=\"Javascript(*.js)|*.js|\" id=\"200\" />\n"
"<string name=\"JAVA_FILES\" caption=\"Java Source(*.java)|*.java|\" id=\"201\" />\n"
"<string name=\"LIVELINK_FILES\" caption=\"Livelink(*.out)|*.out|\" id=\"202\" />\n"
"<string name=\"MAKE_FILES\" caption=\"Makefiles(*.mak)|*.mak|\" id=\"203\" />\n"
"<string name=\"DEF_FILES\" caption=\"Module Definition Files(*.def)|*.def|\" id=\"204\" />\n"
"<string name=\"BATCH_FILES\" caption=\"MS-DOS Batchfiles(*.bat;*.cmd)|*.bat;*.cmd|\" id=\"205\" />\n"
"<string name=\"OPL_FILES\" caption=\"OpenUI Source(*.opl)|*.opl|\" id=\"206\" />\n"
"<string name=\"PASCAL_FILES\" caption=\"Pascal Source(*.pas)|*.pas|\" id=\"207\" />\n"
"<string name=\"PHP_FILES\" caption=\"PHP Source(*.php)|*.php|\" id=\"208\" />\n"
"<string name=\"PROC_FILES\" caption=\"Pro*C/C++ Source(*.pc)|*.pc|\" id=\"209\" />\n"
"<string name=\"PROT_FILES\" caption=\"Protocols(*.log)|*.log|\" id=\"210\" />\n"
"<string name=\"REGISTRATION_FILES\" caption=\"Registration Files (*.reg)|*.reg|\" id=\"211\" />\n"
"<string name=\"RESSOURCE_FILES\" caption=\"Resource Files(*.rc)|*.rc|\" id=\"212\" />\n"
"<string name=\"SQL_SCRIPTS\" caption=\"SQL Scripts(*.sql)|*.sql|\" id=\"213\" />\n"
"<string name=\"SYMBOL_TABLES\" caption=\"Symbol Tables(*.map)|*.map|\" id=\"214\" />\n"
"<string name=\"TEXT_FILES\" caption=\"Text Files(*.txt)|*.txt|\" id=\"215\" />\n"
"<string name=\"DTD_FILES\" caption=\"XML Document Type Definitions(*.dtd)|*.dtd|\" id=\"216\" />\n"
"<string name=\"XML_FILES\" caption=\"XML Files(*.xml)|*.xml|\" id=\"217\" />\n"
"<string name=\"XSD_FILES\" caption=\"XML Schema(*.xsd)|*.xsd|\" id=\"218\" />\n"
"<string name=\"XSL_FILES\" caption=\"XSL Stylesheets(*.xsl)|*.xsl|\" id=\"219\" />\n"
"<string name=\"ALL_FILES\" caption=\"All Files|*.*|\" id=\"220\" />\n"
"</list>\n"
"</strings>\n"
"</gui>";
