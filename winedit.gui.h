...
namespace winlibGUI {
	...
	const int AboutLABEL_id=179;
	const int ALL_FILES_id=221;
	const int autoIndent_id=174;
	const int autoReload_id=176;
	const int backup_id=175;
	const int BATCH_FILES_id=206;
	const int blockBtn_id=184;
	const int centerBtn_id=185;
	const int CG_CONFIG_id=194;
	const int CG_LOG_id=195;
	const int CLOSE_ANYWAY_id=191;
	const int COMPARE_FILES_id=166;
	const int CONFIG_FILES_id=196;
	const int CPUWidthLABEL_id=180;
	const int C_SOURCE_FILES_id=192;
	const int DEF_FILES_id=205;
	const int DTD_FILES_id=217;
	const int EDIT_BREAK_id=156;
	...
	const int EDIT_FORMAT_id=161;
	const int EDIT_HTML_ENTITIES_id=155;
	const int EDIT_INDENT_id=157;
	...
	const int EDIT_READ_ONLY_id=162;
	const int EDIT_SELECT_ALL_id=145;
	const int EDIT_SPACE_INDENT_id=160;
	const int EDIT_TAB_INDENT_id=159;
	const int EDIT_UNDO_id=140;
	const int EDIT_UNINDENT_id=158;
	...
	const int GITHUB_FILES_id=197;
	const int HEADER_FILES_id=198;
	const int HELP_PROJECTS_id=199;
	const int HTML_FILES_id=200;
	const int INFO_ABOUT_id=172;
	const int JAVA_FILES_id=202;
	const int JAVA_SCRIPTS_id=201;
	const int leftBtn_id=183;
	const int linewidth_id=182;
	const int LIVELINK_FILES_id=203;
	const int lwLABEL_id=181;
	const int MAKE_FILES_id=204;
	const int MENU_id=173;
	const int NOREGISTER_id=187;
	const int NOWINDOW_id=188;
	const int OPL_FILES_id=207;
	const int PASCAL_FILES_id=208;
	const int PHP_FILES_id=209;
	const int PreferencesDlg_id=128;
	const int PROC_FILES_id=210;
	const int PROT_FILES_id=211;
	const int REGISTRATION_FILES_id=212;
	const int RESSOURCE_FILES_id=213;
	const int rightBtn_id=186;
	const int SEARCH_NEXT_id=165;
	const int SEARCH_REPLACE_id=164;
	const int SEARCH_SEARCH_id=163;
	const int SQL_SCRIPTS_id=214;
	const int stripLineEnds_id=177;
	const int STYLE_SHEETS_id=193;
	const int SYMBOL_TABLES_id=215;
	const int tabwidth_id=178;
	const int TEXT_FILES_id=216;
	const int UNTITLED_id=189;
	const int WARNING_id=190;
	const int WIN_ARRANGE_id=170;
	const int WIN_CASCADE_id=169;
	const int WIN_CLOSE_ALL_id=171;
	const int WIN_TILE_HORIZ_id=167;
	const int WIN_TILE_VERT_id=168;
	const int XML_FILES_id=218;
	const int XSD_FILES_id=219;
	const int XSL_FILES_id=220;
